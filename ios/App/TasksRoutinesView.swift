            ...
            Form {
                ...
                Section {
                    ...
                    if runOn == .maus {
                        ...
                        Text("Runs the agent and its tools inside its Box virtual machine. The VM wakes automatically for each run; keep V Bot running so its scheduler can launch the job.")
                    } else {
                ...
                Section {
                    ...
                    if kind == .once {
                        ...
                        Label(
                            "This routine uses a schedule added by a newer V Bot. Choose One time or Selected days before saving.",
