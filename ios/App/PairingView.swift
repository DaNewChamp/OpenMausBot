...
struct PairingView: View {
    ...
    private var pairingHero: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Scan the QR code in \(ProductIdentity.displayName). We'll securely choose the best way to connect.")
                    .font(.body)
    ...
    private func submit(_ connection: Connection, credential: String) async {
        ...
        defer {
            ...
            // the in-flight request has fully settled; on success consume it.
