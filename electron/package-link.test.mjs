...
describe("BotMRR package deep links", () => {
  it("accepts a public GitHub package URL", () => {
    const target = "https://raw.githubusercontent.com/acme/bots/main/package.mauspack.json";
  ...
  it("rejects other commands, hosts, protocols, credentials, and non-JSON files", () => {
