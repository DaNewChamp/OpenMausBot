...
export function FleetVmLocationPicker({
  ...
  if (!hosts.length) {
    return (
      <div className="text-[12px] leading-relaxed text-ink-secondary">
        {value ? "The selected machine is unavailable. Reconnect it or choose another machine when the fleet is available." : "No machine is paired. Install V Bot or a bridge on a computer in your fleet, then pick it here."}
      </div>
    );
  }
  return (
