...
| Grok Reconstructed | Local reconstructed Grok Bot 0.18 desktop app | Desktop-only loopback adapter. iOS keeps talking to OpenMausBot. Unavailable unless that app is running. |
