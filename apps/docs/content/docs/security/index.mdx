...
- Optional Grok Bot 0.18 Reconstructed compatibility is local to the desktop harness. The reconstructed loopback gateway, discovery token, and host paths are never published through Companion or iOS.
